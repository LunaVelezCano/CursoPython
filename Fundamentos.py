...
#Atributos: Son variables que pertenecen a una clase o a sus objetos. Definen las propiedades de un objeto. Por ejemplo, pensemos en una persona:
#¿Qué caracteriza a una persona en general? Las personas tienen nombre, edad, dirección, etc. En términos de POO, estos serían los atributos de 
# la clase Person.
#Métodos: Son funciones definidas dentro de una clase que operan sobre sus objetos. Definen los comportamientos de un objeto. Siguiendo con el 
#ejemplo de una persona, ¿Qué acciones puede realizar una persona? Puede hablar, caminar, comer, etc. En POO, estas acciones serían métodos de la
# clase Person.
...
#al usar herencia vimos el método init() que es le cosntructor, el mismo es llamado automáticamente cuando se crea una nueva instancia de 
# una clase y se utiliza para inicializar los atributos del objeto.
...
#La función super() en Python te permite acceder y llamar a métodos definidos en la superclase desde una subclase.
#  Esto es útil cuando quieres extender o modificar la funcionalidad de los métodos de la superclase sin tener que repetir
...
#La clase Student, que es una subclase de Person, utiliza super().__init__(name, age) para llamar al constructor de la superclase Person
#  y luego sobrescribe el método greet() para agregar información específica del estudiante.

#Jerarquía de Clases y Constructores

#¿Qué sucede si una clase tiene una clase padre y esa clase padre tiene otra clase padre? En este caso, usamos super()
#  para asegurar que todas las clases padre sean inicializadas correctamente.
...
#Estos métodos proporcionan una manera conveniente de representar y comparar objetos, lo que facilita la depuración y
#  el uso de los objetos en el código.

#Importancia de Aprender estos Conceptos

#Comprender y utilizar super(), los métodos por defecto y los constructores es crucial para escribir código limpio, eficiente y reutilizable
#  en Python. Estos conceptos permiten:
